...
(function() {
  var LiveDbRethinkDB, async, castDocToSnapshot, castItemToOp, castOpToDoc, castSnapshotToDoc, decodeValue, docVal, encodeValue, exports, purgeTable, r, retry, zlib, _,
  ...
  exports = module.exports = function(rethink, s3, options) {
    return new LiveDbRethinkDB(rethink, s3, options);
  };
  ...
  LiveDbRethinkDB = (function() {
    function LiveDbRethinkDB(rethink, s3, options) {
          ...
          s3Requests.push((function(docName, cName) {
            return function(cb) {
              return r(cb, function(retry) {
                console.log('cName & docname', cName, docName);
/*                return _this.s3.getObject({
                  Bucket: _this.bucketName,
                  Key: "" + cName + "/" + docName
                }, function(err, data) {
      ...
      return async.parallelLimit(s3Requests, 16, function(err) {
        ...
        return r(callback, function(retry) {
          return _this.rethink.batchGetItem({
    ...
    LiveDbRethinkDB.prototype.purgeDocTable = function(name, readCapacity, writeCapacity, cb) {
      return purgeTable(this.rethink, {
        TableName: name,
    ...
    LiveDbRethinkDB.prototype.purgeOpsTable = function(name, readCapacity, writeCapacity, cb) {
      return purgeTable(this.rethink, {
        TableName: name,
        AttributeDefinitions: [
          {
